...
records agree on lastname is much lower. Therefore, agreement on lastname makes
it much more likely that the two records belong to the same entity. 

This is what the probabilistic linkage framework intially formalised by Fellegi
...
categories (such as lastname) this probability wil be small. 
